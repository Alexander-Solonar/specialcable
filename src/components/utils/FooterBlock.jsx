const FooterBlock = ({ title, items }) => {
  return (
    <div className="border-b-[1px] border-soft-blue border-opacity-10 pb-4 ml:w-1/4 ml:border-none">
      <h3 className="mb-4 text-xs font-bold uppercase sm:tracking-widest ml:text-base">{title}</h3>
      <ul className="flex gap-x-8 gap-y-4 text-[11px] leading-4 sm:uppercase sm:tracking-widest ml:flex-col ml:text-base ml:normal-case ml:tracking-normal">
